...
<head>
    ...
    <title>GIOTAI - {{$data_seo->meta_title}}</title>
    <!---seo------->
    ...
    @else
        <meta property="og:image" content="../libs/giotai.png"/>
    @endif

    <link rel="shortcut icon" type="image/x-icon" href="../libs/giotai.png">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="footer">
                                ...
                                <div class="ft__details">
                                    <div class="row">
                                        <div class="col-sm-9">
                                            <p>GIÓ TAI là một trong những nơi hướng đến cộng đồng nội thất Việt Nam</p>
                                        </div>
                                    </div>
